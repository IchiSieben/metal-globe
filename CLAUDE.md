...
⚠️ **IMPORTANTE:** Sandra (colega/usuaria) ya tiene acceso a la versión ESTABLE colgada
en Hosting (la última antes del grafo genealógico). El desarrollo local es la versión
NUEVA — modificar local no afecta lo que Sandra ve hasta que se suba a Hosting.
